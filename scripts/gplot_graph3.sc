...
plot "motion_summary.csv" using 1:2 with lines lt 1 lc 1 lw 2 ti "Circ" axis x1y1, \
     "motion_summary.csv" using 1:3 with lines lt 2 lc 3 lw 2 ti "Radial" axis x1y1, \
     "motion_summary.csv" every 15::1 using 1:2 with points lt 1 lc 1 lw 2 ti "" axis x1y1, \
	  "motion_summary.csv" every 15::1 using 1:3 with points lt 2 lc 3 lw 2 ti "" axis x1y1
